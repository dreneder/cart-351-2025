...
def thankyou_t2():
    ...
    if pickDog == "Countryside":
        ...
        imgPath = "PINEAPPLEDOG.jpg"
    # renders everything in thank you

    return render_template("thankyou_t2.html", pickDog=pickDog, pickDonut=request.args["selectDonut"], pickIceCream=request.args["selectIceCream"], imgPath=imgPath)
